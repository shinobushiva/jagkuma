...
public final class QuizData implements Parcelable{
	private static final String QueryURL = "http://kumamotogotochi.appspot.com/client/quizes?";
	...
	public static String getQueryURL(long pinId) {
		return new StringBuilder(QueryURL)
			.append(User.APPKEY)
			.append("&pinId=").append(pinId).toString();
	}
	...
	public String createLoggingQueryURL(User user, boolean correctness, long answeringTime,
		...
		StringBuilder builder = new StringBuilder()
			.append("http://kumamotogotochi.appspot.com/client/answer?")
			.append(User.APPKEY)
